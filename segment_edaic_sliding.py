...
# 參數設定
source_csv = "/scratch/s5944562/HuBERT/datasets/edaic/utterance_table_balanced.csv"
output_dir = "/scratch/s5944562/HuBERT/datasets/edaic_segments"
...
seg_df.to_csv("utterance_table_edaic_segmented.csv", index=False)
