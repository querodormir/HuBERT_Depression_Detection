...
# 設定路徑
feature_dir = "/scratch/s5944562/HuBERT/features_mix_layer9"
output_file = "/scratch/s5944562/HuBERT/output/mix_l9_results.txt"
os.makedirs("/scratch/s5944562/HuBERT/output", exist_ok=True)
